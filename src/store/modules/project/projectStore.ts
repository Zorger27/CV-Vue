  ...
  projectStore:
    [
      ...
      },
      {
        ...
        end_date_ua: "Травень 2022",
        end_date_es: "Mayo de 2022",
        description_en: "📝 A web application for convenient task management, implemented using modern web technologies. ✔️ Allows you to add, edit, delete tasks, mark them as completed and clear the list entirely. 💡 The code is flexible, easy to modify, and adaptable for integration with any platform.",
        description_ua: "📝 Вебдодаток для зручного управління завданнями, реалізований із використанням сучасних вебтехнологій. ✔️ Дозволяє додавати, редагувати, видаляти завдання, відзначати виконання та очищати список повністю. 💡 Код гнучкий, легко модифікується й адаптується для інтеграції з будь-якими платформами.",
        description_es: "📝 Una aplicación web para una gestión de tareas conveniente, implementada con tecnologías web modernas. ✔️ Permite agregar, editar, eliminar tareas, marcarlas como completadas y limpiar la lista por completo. 💡 El código es flexible, fácil de modificar y adaptable para integrarse con cualquier plataforma.",
        type_en: "WEB-application",
        type_ua: "WEB-додаток",
        type_es: "Aplicación Web",

  ...
  projectStore:
    [
      ...
      },
      {
        ...
        description_en: "This is a modern single-page application (SPA) that provides detailed and visually appealing information about me in three languages: Ukrainian, English and Spanish. The site covers everything that matters: Detailed resume (projects with descriptions, diplomas, certificates, work experience, skills, and education) and Extra section (examples of completed works: Calculator, To-do list, Notes, Weather, Currency exchange rates, Cryptocurrencies, 3D graphics, Games, and much more).",
        description_ua: "Це сучасний односторінковий додаток (SPA), який детально та наочно представляє інформацію про мене трьома мовами: українською, англійською та іспанською. Сайт охоплює все, що важливо: Детальне резюме (проекти з описами, дипломи, сертифікати, досвід роботи, навички та освіта) і Екстра-розділ (приклади готових робіт: калькулятор, список справ, нотатки, погода, курси валют, криптовалюти, 3D графіка, ігри та багато іншого). 🌟",
        description_es: "Esta es una aplicación web de una sola página (SPA) que presenta de manera detallada y visualmente atractiva información sobre mí en tres idiomas: ucraniano, inglés y español. El sitio cubre todo lo que es importante: Currículum detallado (proyectos con descripciones, diplomas, certificados, experiencia laboral, habilidades y educación) y Sección extra (ejemplos de trabajos realizados: Calculadora, Lista de tareas, Notas, El Tiempo, Los tipos de cambio, Criptomonedas, Gráficos 3D, Juegos y mucho más). 🌟",
        type_en: "Single page application",
        type_ua: "Односторінковий додаток",
        type_es: "Aplicación de una sola página",

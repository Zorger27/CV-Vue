  ...
  projectStore:
    [
      ...
      },
      {
        ...
        description_en: "This web application allows the user to interactively change the model they like. The changes occur in 3D mode. The user can examine this model very carefully from different sides: approach it, move away from it, turn it in different directions.",
        description_ua: "Цей веб-додаток дозволяє користувачеві інтерактивно змінювати модель, що сподобалася. Зміни відбуваються у 3D режимі. Користувач може цю модель дуже уважно розглянути з різних сторін: наближатися, віддалятися від неї, повертати в різних напрямках.",
        description_es: "Esta aplicación web permite al usuario modificar de forma interactiva el modelo que desee. Los cambios se realizan en modo 3D. El usuario puede examinar este modelo con mucho cuidado desde diferentes ángulos: acercarse a él, alejarse de él, girarlo en diferentes direcciones.",
        type_en: "Single page application",
        type_ua: "Односторінковий додаток",
        type_es: "Aplicación de una sola página",
        techno: "Three.js, Orbit controls, Vue.js, VueX, HTML5, CSS3, FlexBox CSS, TypeScript, JavaScript",

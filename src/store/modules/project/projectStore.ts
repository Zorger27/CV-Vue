  ...
  projectStore:
    [
      ...
      },
      {
        ...
        description_ua: "🔽 Елегантний та ефективний веб-додаток, побудований виключно за допомогою CSS3. ✨ Проста архітектура забезпечує кроссплатформність та легкість інтеграції в будь-які проекти. 💡 Ідеально працює \"з коробки\" і легко адаптується під будь-які потреби! 🚀",

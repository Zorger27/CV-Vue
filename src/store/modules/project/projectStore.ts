  ...
  projectStore:
    [
      ...
      },
      {
        ...
        end_date_ua: "Травень 2022",
        end_date_es: "Mayo de 2022",
        description_en: "📬 A user-friendly web application for collecting user information and sending messages to the administrator. ✍️ The form features smart data validation, ensuring the accuracy of submitted information. 💡 Lightweight and adaptive code makes this project a versatile solution for any digital platform. 🌐💻",
        description_ua: "📬 Зручний вебдодаток для збору інформації про користувачів та передачі повідомлень адміністратору. ✍️ Форма з інтелектуальною валідацією даних гарантує коректність відправленої інформації. 💡 Легкий та адаптивний код робить проєкт універсальним рішенням для будь-яких цифрових платформ. 🌐💻",
        description_es: "📬 Una aplicación web fácil de usar para recopilar información de los usuarios y enviar mensajes al administrador. ✍️ El formulario incluye validación inteligente de datos, garantizando la precisión de la información enviada. 💡 Un código ligero y adaptable convierte este proyecto en una solución versátil para cualquier plataforma digital. 🌐💻",
        type_en: "WEB-application",
        type_ua: "WEB-додаток",
        type_es: "Aplicación Web",
        techno: "HTML5, CSS3, FlexBox CSS, Markdown, Git, GitHub",

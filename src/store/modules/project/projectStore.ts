  ...
  projectStore:
    [
      ...
      },
      {
        ...
        description_en: "This modern web application is designed to provide a convenient and visual display of current foreign exchange rates. The app retrieves real-time data from the National Bank of Ukraine API, displaying exchange rates relative to the Ukrainian hryvnia (UAH) in innovative and interactive formats: Table or List, Creeping line, Creeping line 3D, Three-in-One.",
        description_ua: "Це сучасний вебдодаток, створений для зручного та наочного відображення актуальних курсів іноземних валют. Додаток отримує дані в режимі реального часу через API Національного банку України, відображаючи курси валют відносно української гривні (UAH) в інноваційних та інтерактивних форматах: Таблиця або Список, Рядок, що біжить, Рядок, що біжить 3D, Три в Одному.",
        description_es: "Esta moderna aplicación web está diseñada para proporcionar una visualización cómoda y clara de los tipos de cambio de divisas actuales. La aplicación obtiene datos en tiempo real del API del Banco Nacional de Ucrania, mostrando los tipos de cambio en relación con la grivna ucraniana (UAH) en formatos innovadores e interactivos: Tabla o Lista, Línea progresiva, Línea progresiva 3D, Tres en Uno.",
        type_en: "Single page application",
        type_ua: "Односторінковий додаток",
        type_es: "Aplicación de una sola página",

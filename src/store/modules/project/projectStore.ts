  ...
  projectStore:
    [
      ...
      },
      {
        ...
        end_date_ua: "Січень 2024",
        end_date_es: "Enero de 2024",
        description_en: "CuboVerse is an interactive 3D platform that allows users to observe and control unique cube models. Explore a variety of textures, colors, and cube movements in real-time. Scale, rotate, and change the direction of cubes while observing their orbital rotation.",
        description_ua: "CuboVerse — це інтерактивна 3D-платформа, що дозволяє користувачам спостерігати та керувати унікальними моделями кубів. Досліджуйте різноманітні текстури, кольори та рухи кубів у режимі реального часу. Масштабуйте, обертайте та змінюйте напрямок руху кубів, спостерігаючи за їх орбітальним обертанням.",
        description_es: "CuboVerse es una plataforma interactiva en 3D que permite a los usuarios observar y controlar modelos únicos de cubos. Explora una variedad de texturas, colores y movimientos de los cubos en tiempo real. Escala, rota y cambia la dirección de los cubos mientras observas su rotación orbital.",
        type_en: "Single page application",
        type_ua: "Односторінковий додаток",
        type_es: "Aplicación de una sola página",
        techno: "Three.js, Orbit controls, Vue.js, VueX, HTML5, CSS3, FlexBox CSS, JavaScript",

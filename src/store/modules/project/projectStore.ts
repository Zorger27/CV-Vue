  ...
  projectStore:
    [
      ...
      },
      {
        ...
        description_ua: "⚛️ Reactorium — це колекція із декількох веб-застосунків на React: калькулятор, список завдань, memory-гра та обертальний куб. 🚀 Reactorium — це простір, де сучасні технології поєднуються з простими й захопливими ідеями. Це проєкт про те, як із коду народжуються зручні інструменти й маленькі радощі.",

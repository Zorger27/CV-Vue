  ...
  projectStore:
    [
      ...
      },
      {
        ...
        end_date_ua: "Травень 2022",
        end_date_es: "Mayo de 2022",
        description_en: "📝 A web application for convenient task management, implemented using modern web technologies. ✔️ Allows you to add, edit, delete tasks, mark them as completed and clear the list entirely.",
        description_ua: "📝 Вебдодаток для зручного управління завданнями, реалізований із використанням сучасних вебтехнологій. ✔️ Дозволяє додавати, редагувати, видаляти завдання, відзначати виконання та очищати список повністю.",
        description_es: "📝 Una aplicación web para una gestión de tareas conveniente, implementada con tecnologías web modernas. ✔️ Permite agregar, editar, eliminar tareas, marcarlas como completadas y limpiar la lista por completo.",
        type_en: "WEB-application",
        type_ua: "WEB-додаток",
        type_es: "Aplicación Web",

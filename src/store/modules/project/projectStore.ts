  ...
  projectStore:
    [
      ...
      },
      {
        ...
        description_en: "⚛️ Reactorium is a collection from several React web applications: a calculator, a to-do list, a memory game, and a rotating cube. 🚀 Reactorium is where modern technologies meet simple and engaging ideas. It’s a project about turning code into useful tools and little joys.",
        description_ua: "⚛️ Reactorium — це колекція із декількох веб-застосунків на React: калькулятор, список завдань, memory-гра та обертальний куб. 🚀 Reactorium — це простір, де сучасні технології поєднуються з простими й захопливими ідеями. Це проект про те, як із коду народжуються зручні інструменти й маленькі радощі.",
        description_es: "⚛️ Reactorium es una colección de varios aplicaciones web en React: una calculadora, una lista de tareas, un memory game y un cubo giratorio. 🚀 Reactorium es el lugar donde la tecnología moderna se une con ideas simples y atractivas. Es un proyecto sobre cómo el código puede convertirse en herramientas útiles y pequeñas alegrías.",
        type_en: "Single page application",
        type_ua: "Односторінковий додаток",
        type_es: "Aplicación de una sola página",
        techno: "React, React Router, Redux Toolkit, React i18next, Vite, HTML5, SCSS, FlexBox CSS, Grid CSS, JavaScript, Markdown, Git, GitHub, Google Search Console, Google Analytics, Open Graph protocol, Favicon, Sitemap, Robots.txt",

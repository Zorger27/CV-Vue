  ...
  projectStore:
    [
      ...
      },
      {
        ...
        description_en: "This is a modern single-page application (SPA) that provides detailed and visually appealing information about me in three languages: Ukrainian, English and Spanish. The site covers everything that matters: Detailed resume (projects with descriptions, diplomas, certificates, work experience, skills, and education) and Extra section (examples of completed works: Calculator, To-do list, Notes, Weather, Exchange rates, Cryptocurrencies, 3D graphics, Games and much more).",

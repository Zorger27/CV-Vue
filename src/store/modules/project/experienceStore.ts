    ...
    [
      {
        ...
        tasks_en: "Website design development. Creation of a site prototype. Building a website (SPA) on Vue.js with using TypeScript. Connecting Google Analytics 4.0 for a Vue.js website. Porting programs written in pure JavaScript code to Vue.js, which uses TypeScript.",
        tasks_ua: "Розробка дизайну веб-сайту. Створення прототипу сайту. Створення веб-сайту на Vue.js з використанням TypeScript. Підключення Google Analytics 4.0 для веб-сайту на Vue.js. Перенесення програм, написаних на чистому JavaScript коді у Vue.js, де використовується TypeScript.",
        tasks_es: "Desarrollo de diseño de sitios web. Creación de un prototipo de sitio. Creación de un sitio web (SPA) en Vue.js con el uso de TypeScript. Conectando Google Analytics 4.0 para un sitio web de Vue.js. Portar programas escritos en código JavaScript puro a Vue.js, que usa TypeScript.",
      ...
      },
      {
        ...
        tasks_es: "Creación de un logo de empresa. Creación de diseño de sitio web. Trabajar con CMS Joomla. Configuración y lanzamiento de campañas publicitarias en Google, YouTube, Facebook, Instagram. Creación de videoclips informativos para YouTube. Conexión del sitio con Google Merchant Center. Registro en Google Map. Programación del tostador de café. Configuración de las computadoras de los empleados. Configuración de una red local.",

    ...
    [
      {
        ...
        tasks_ua: "Створення прототипу сайту. Розробка дизайну веб-сайту. Створення веб-сайту на Vue.js з використанням TypeScript. Реєстрація доменного імені. Підключення доменного імені до сайту. Підключення Google Analytics 4.0. Реєстрація сайту в Google Search Console та подальше проведення його індексації. Створення файлів Sitemap.xml та Robots.txt. Анімація тексту, блоків. Створення 3D-моделей за допомогою Three.js.",
        tasks_es: "Creación de un prototipo de sitio. Desarrollo de diseño de sitios web. Creación de un sitio web (SPA) en Vue.js con el uso de TypeScript. Registro del nombre de dominio. Conexión de un nombre de dominio a un sitio. Conectando Google Analytics 4.0. Registro del sitio en Google Search Console y su posterior indexación. Creación de archivos Sitemap.xml y Robots.txt. Creación de modelos 3D usando Three.js.",
